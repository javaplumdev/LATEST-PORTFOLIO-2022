			...
			<div className="container">
				<div>
					...
					<p className="fs-3">
						...
						specializing in developing solutions with JavaScript, React, and Web
						designs.
					</p>
				</div>
				<div className="mt-5">
					<Row>
						...
						<Col md={8}>
							<p className="p-text fs-5">
								...
								self-taught developer with a foundational understanding of both
								web design and programming. I was motivated and propelled
								forward to create many ideas and designs by my curiosity in this
								area. I've offered programming assistance to a few individuals
								and assisted a group of independent programmers in rebuilding an
								application. In my spare time, I wrote programming and came up
								with web design ideas.
							</p>
							<div className="my-5">
								<h4>Technologies</h4>
